...
public class CommonDBTM extends CommonGLPI {
     ...
     * {@inheritDoc}
     */
    public boolean $get_item_to_display_tab = true;
...
//    }
     ...
     *
     * @param $classname Force class (to avoid late_binding on inheritance)
     * @return string
     **/
    static String getTable(Object $classname) {
//        if ($classname == = null) {
...
//        return self::$tables_of[$classname];
    ...
    static String getForeignKeyField() {
//        $classname = get_called_class();
//
...
//        return self::$foreign_key_fields_of[$classname];
     ...
     *
     * @param $field     Name of the field (or SQL keyword like '*')
     * @param $classname Forced classname (to avoid late_binding on inheritance)
     * @return string
     **/
    static String getTableField(String $field, String $classname) {
...
//        $this -> fields = $rs;
     ...
     * @since 9.2
     */
    public CommonDBTM getFromIter(DBmysqlIterator $iter) {
//        $item = new static ;
//
//        foreach($iter as $row) {
//            if (!isset($row["id"])) {
...
//        }
     ...
     * @since 9.2
     */
    public boolean getFromDBByCrit(String[] $crit) {
        //global $DB;

//        $crit = ['SELECT' =>'id', 'FROM' =>$this -> getTable(), 'WHERE' =>$crit];
//
...
//            trigger_error(sprintf('getFromDBByCrit expects to get one result, %1$s found in query "%2$s".',count($iter),$iter -> getSql()),E_USER_WARNING);
//        }
        return false;
    }
     ...
     *
     * @param $request expression
     * @return boolean true if succeed else false
     * @since 9.3
     **/
    public boolean getFromDBByRequest(String[] $request) {
//        global $DB;
//
...
//        }
     ...
     * @param $limit     limit retrieved data if needed (default '')
     * @return array all retrieved data in a associative array by id
     **/
    String[] find(String[] $condition, String $order, int $limit) {
//        global $DB;
//
//        $criteria = ['FROM' =>$this -> getTable()];
//
//        if (count($condition)) {
...
//        return [$this -> getType(), $this -> fields['id']];
     ...
     * @return boolean
     **/
    boolean updateInDB(String[] $updates, String[] $oldvalues) {
//        global $DB;
//
...
//        }
     ...
     * @return boolean true if succeed else false
     **/
    boolean deleteFromDB(boolean $force) {
//        global $DB;
//
//        if (($force == 1)
//                || !$this -> maybeDeleted()
...
//        unset($_SESSION['saveInput'][$this -> getType()]);
     ...
     * @since 0.84
     **/
    protected String[] restoreInput(String[] $default) {
...
//        }
     ...
     *
     * @param $input   the _POST vars returned by the item form when press add
     * @param $options with the insert options
     *                 - unicity_message : do not display message if item it a duplicate (default is yes)
     * @param $history do history log ? (true by default)
     * @return integer the new ID of the added item (or false if fail)
     **/
    boolean add(String[] $input, String[] $options, boolean $history) {
//        global $DB, $CFG_GLPI;
//
//        if ($DB -> isSlave()) {
//            return false;
...
//        }
     ...
     *
     * @param $override_input custom input to override
     * @param $history        do history log ? (true by default)
     * @return integer the new ID of the clone (or false if fail)
     * @since 9.5
     */
    int clone(String[] $override_input, boolean $history) {
//        global $DB, $CFG_GLPI;
//
//        if ($DB -> isSlave()) {
//            return false;
...
//        }
     ...
     * @since 0.84
     **/
    String[] addNeededInfoToInput(String[] $input) {
        return $input;
    }
     ...
     * @return array the modified $input array
     **/
    String[] prepareInputForAdd(String[] $input) {
        return $input;
    }
     ...
     * @since 9.5
     **/
    String[] prepareInputForClone(String[] $input) {
//        unset($input['id']);
//        unset($input['date_mod']);
//        unset($input['date_creation']);
        return $input;
     ...
     *
     * @param $input   the _POST vars returned by the item form when press update
     * @param $history do history log ? (default 1)
     * @param $options with the insert options
     * @return boolean true on success
     **/
    boolean update(String[] $input, boolean $history, String[] $options) {
...
//        }
     ...
     * @return array the modified $input array
     **/
    String[] prepareInputForUpdate(String[] $input) {
        return $input;
    }
     ...
     *
     * @param $input   the _POST vars returned by the item form when press delete
     * @param $force   force deletion (default 0)
     * @param $history do history log ? (default 1)
     * @return boolean true on success
     **/
    boolean delete(String[] $input, boolean $force, boolean $history) {
//        global $DB;
//
//        if ($DB -> isSlave()) {
//            return false;
...
//        }
     ...
     *
     * @param $input   the _POST vars returned by the item form when press restore
     * @param $history do history log ? (default 1)
     * @return boolean true on success
     **/
    boolean restore(String[] $input, boolean $history) {
...
//        $this -> fields =[];
     ...
     * @since 0.83
     **/
    boolean canAddItem(String $type) {
...
//        }
     ...
     * @since 0.83
     **/
    boolean canMassiveAction(String $action, int $field, String $value) {
        return true;
    }
     ...
     * @since 9.1
     **/
    boolean showDates(String[] $options) {
...
//        Html::closeForm ();
     ...
     * @since 0.84
     **/
    int initForm(int $ID, String[] $options) {
...
//                        "</th>";
//                        echo "<th class='right'><label for='dropdown_is_recursive$rand'>".__('Child entities').
//                        "</label></th><th>";
//                        if ($params['canedit']) {
//                            if ($this instanceof CommonDBChild) {
//                                echo Dropdown::getYesNo($this -> isRecursive());
//                                if (isset($this -> fields["is_recursive"])) {
//                                    echo "<input type='hidden' name='is_recursive' value='".$this->
//                                    fields["is_recursive"]. "'>";
//                                }
...
//
//                            } else {
//                                Dropdown::showYesNo ("is_recursive", $this -> fields["is_recursive"], -1, ['rand' =>
//                                $rand]);
...
//        }
     ...
     * @return boolean
     **/
    boolean can(int $ID, String $right, String[] $input) {
        // Clean ID :
...
//        }
     ...
     *
     * @param $recursive set true to accept recursive items of ancestors
     *                of active entities (View case for example) (default false)
     * @return boolean
     * @since 0.85
     **/
    boolean checkEntity(boolean $recursive) {
...
//        }
     ...
     * @return boolean
     **/
    boolean canGlobal(String $right) {
...
//        return array_key_exists('is_dynamic', $this -> fields);
     ...
     * @since 0.84
     **/
    boolean useDeletedToLockIfDynamic() {
...
//        }
     ...
     **/
    static String getCompleteNameField() {
        return "completename";
    }
...
//        return NOT_AVAILABLE;
     ...
     * @since 0.84
     **/
    String getPreAdditionalInfosForName() {
        return "";
    }
     ...
     * @since 0.84
     **/
    String getPostAdditionalInfosForName() {
        return "";
    }
     ...
     **/
    String getNameID(String[] $options) {
...
//        return $options;
     ...
     **/
    public String[] rawSearchOptions() {
//        $tab = [];
//
//        $tab[] = [
//        'id' =>'common',
...
//        return $tab;
     ...
     *
     * @param $itemtype Item type, defaults to null
     * @return array
     * @since 9.2
     **/
    static String[] getSearchOptionsToAdd(String $itemtype) {
//        $options = [];
//
//        $classname = get_called_class();
...
//        return $options;
     ...
     * @since 0.85
     **/
    static boolean showMassiveActionsSubForm(MassiveAction $ma) {
        return false;
    }
     ...
     * This should be overloaded in Class
     **/
    String[] getForbiddenStandardMassiveAction() {
        return new String[]{};
    }
     ...
     * @since 9.5.0
     **/
    public String[] getForbiddenSingleMassiveActions() {
//        $excluded = [
//        '*:update',
//                '*:delete',
//                '*:remove',
...
//        return $excluded;
     ...
     * @since 9.5.0
     **/
    public String[] getWhitelistedSingleMassiveActions() {
        return new String[]{"MassiveAction:add_transfer_list"};
    }
     ...
     * This should be overloaded in Class
     **/
    String[] getSpecificMassiveActions(Object $checkitem) {
//        global $DB;
//
//        $actions = [];
...
//            _x('button', 'Associate to an appliance');
//        }
//
//        return $actions;
        return new String[]{};
...
//        return Dropdown::show (get_called_class(), $options);
     ...
     **/
    String[] getSearchOptionByField(String $field, String $value, String $table) {
...
//        return $this -> searchopt;
     ...
     * @since 0.83
     **/
    int getSearchOptionIDByField(String $field, String $value, String $table) {
...
//                        case 'string':
//                            if (strlen($value) > 255) {
//                                Toolbox::logWarning ("$value exceed 255 characters long (".strlen($value).
...
//        }
     ...
     **/
    boolean checkSpecificValues(String $datatype, String[] $value) {
        return true;
    }
     ...
     **/
    String[] getUnicityFieldsToDisplayInErrorMessage() {
...
//                'entities_id' =>Entity::getTypeName (1)];
    ...
    String[] getUnallowedFieldsForUnicity() {
        return new String[]{"alert", "comment", "date_mod", "id", "is_recursive", "items_id"};
    }
     ...
     * @return string
     **/
    String getUnicityErrorMessage(String[] $msgs, String[] $unicity, String[] $doubles) {
...
//        return $message_text;
     ...
     **/
    boolean checkUnicity(boolean $add, String[] $options) {
//        global $CFG_GLPI;
//
//        $p = [
...
//        return $result;
     ...
     * @param $force   force purge not on put in trashbin (default 0)
     * @param $history do history log ? (true by default)
     * @return boolean
     **/
    boolean deleteByCriteria(String[] $crit, boolean $force, boolean $history) {
//        global $DB;
//
//        $ok = false;
...
//        return $ok;
     ...
     **/
    static int getItemEntity(String $itemtype, int $items_id) {
...
//        }
     ...
     * @param $values  with the value to display or a Single value
     * @param $options Array of options
     * @return string the string to display
     * @since 0.83
     **/
    static String getSpecificValueToDisplay(String $field, String $values, String[] $options) {
...
//        }
     ...
     *
     * @param $field_id_or_search_options id of the search option field
     *                             or field name
     ...
     * @since 0.83
     **/
    String getValueToDisplay(int $field_id_or_search_options, String $values, String[] $options) {
//        global $CFG_GLPI;
//
//        $param = [
//        'comments' =>false,
...
//        return $value;
     ...
     *
     * @param $field   name of the field
     * @param $name    name of the select (if empty use linkfield) (default '')
     * @param $values  with the value to select or a Single value (default '')
     * @param $options aArray of options
     * @return string the string to display
     * @since 0.83
     **/
    static String getSpecificValueToSelect(String $field, String $name, String $values, String[] $options) {
        return "";
    }
     ...
     *                             or field name
     *                             or search option array
     * @param $name                       name of the select (if empty use linkfield)
     *                             (default '')
     * @param $values                     default value to display
     *                             (default '')
     * @param $options                    array of possible options:
     *                             Parameters which could be used in options array :
     *                             - comments : boolean / is the comments displayed near the value (default false)
     ...
     * @since 0.83
     **/
    String getValueToSelect(int $field_id_or_search_options, String $name, String $values, String[] $options) {
//        global $CFG_GLPI;
//
//        $param = [
//        'comments' =>false,
...
//        self::$plugins_forward_entity[$for_itemtype][] =$to_itemtype;
     ...
     * @since 0.84
     **/
    static boolean isEntityForwardTo(String $itemtype) {
...
//        }
     ...
     *
     * @param $interface (defalt 'central')
     * @return array array of rights to display
     * @since 0.85
     **/
    String[] getRights(String $interface) {
...
//        return $values;
     ...
     * Generate link
     *
     * @param $link original string content
     * @param $item item used to make replacements
     * @return array of link contents (may have several when item have several IP / MAC cases)
     * @since 9.1
     **/
    static String[] generateLinkContents(String $link, CommonDBTM $item) {
//        return Link::generateLinkContents ($link, $item);
     ...
     * @since 9.2
     **/
    String[] addFiles(String[] $input, String[] $options) {
//        global $CFG_GLPI;
//
//        $default_options = [
//        'force_update' =>false,
...
//        return $input;
     ...
     *
     * @param $field   Field name
     * @param $options Withtemplate parameter
     * @param $value   Optional value (if field to check is not part of current itemtype)
     * @return string
     */
    public String getAutofillMark(String $field, String[] $options, String $value) {
//        $mark = '';
//        $title = null;
...
//        }
     ...
     *
     * @param $items_id The ID of the item to evaluate.
     * @param $parents_id  The wanted parent of the specified item.
     * @return bool True if there is a circular relation.
     * @since 9.5.0
     */
    static boolean checkCircularRelation(int $items_id, int $parents_id) {
//        global $DB;
//
...
//        // No circular relations
     ...
     * @return array
     */
    public String[] getITILTickets(boolean $count) {
//        $ticket = new Ticket();
//        $problem = new Problem();
//        $change = new Change();
//
...
//        return $data;
     ...
     * @since 9.5
     */
    public static String getFriendlyNameById(int $id) {
//        $item = new static ();
//        $item -> getFromDB($id);
...
//        return $this -> computeFriendlyName();
     ...
     * @since 9.5
     */
    protected String computeFriendlyName() {
