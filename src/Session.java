...
class Session {
    ...
    //const DEBUG_MODE        =2;
    static String[] $_SESSION = new String[]{};
...
//            $tosave = ['glpi_plugins', 'glpicookietest', 'phpCAS', 'glpicsrftokens', 'glpiskipMaintenance'];
//            $save = [];
//            foreach($tosave as $t) {
//                if (isset($_SESSION[$t])) {
//                    $save[$t] = $_SESSION[$t];
...
//                    }
//                    $_SESSION['glpi_dropdowntranslations'] = DropdownTranslation::getAvailableTranslations
...
//        return $_SESSION['glpirootentityname'];
     ...
     * @return boolean
     **/
    static boolean isMultiEntitiesMode() {
//
...
//        return $_SESSION['glpi_multientitiesmode'];
     ...
     * @since 9.3.2
     **/
    static boolean canViewAllEntities() {
        // Command line can see all entities
//        return (isCommandLine() || ((countElementsInTable("glpi_entities")) == count($_SESSION["glpiactiveentities"])));
        return true;
    }
     ...
     **/
    static void addToNavigateListItems(String $itemtype, int $ID) {
//        $_SESSION['glpilistitems'][$itemtype][] =$ID;
     ...
     **/
    static void initNavigateListItems(String $itemtype, String $title) {
//
//        if (empty($title)) {
//            $title = __('List');
//        }
...
//        $_SESSION['glpilisturl'][$itemtype] = $url;
     ...
     **/
    static boolean changeActiveEntities(int $ID, boolean $is_recursive) {
...
//        }
     ...
     * @param $with_plugins  Whether to load plugin languages or not
     * @return void
     **/
    static boolean loadLanguage(String $forcelang, boolean $with_plugins) {
...
//        }
     ...
     * @since 0.84
     **/
    static boolean isCron() {

//        return (isset($_SESSION["glpicronuserrunning"]) && (isCommandLine() || strpos($_SERVER['PHP_SELF'], '/cron.php')));
        return true;
    }
     ...
     *
     * @param $force_human Force human / do not return cron user (true by default)
     * @return false|int|string false if user is not logged in
     * int for user id, string for cron jobs
     **/
    static boolean getLoginUserID(boolean $force_human) {
...
//        }
     ...
     * @since 0.85
     **/
    static boolean checkValidSessionId() {
...
//        }
     ...
     * @return boolean
     **/
    static boolean haveAccessToAllOfEntities(String[] $tab) {
...
//        }
     ...
     * @param $is_recursive if recursive item (default 0)
     * @return boolean
     **/
    static boolean haveAccessToEntity(int $ID, boolean $is_recursive) {
...
//        return in_array($ID, getAncestorsOf("glpi_entities", $_SESSION['glpiactiveentities']));
     ...
     * @return boolean
     **/
    static boolean haveAccessToOneOfEntities(String[] $tab, boolean $is_recursive) {
...
//        }
     ...
     * @return boolean
     **/
    static boolean haveRecursiveAccessToEntity(int $ID) {
...
//        }
     ...
     * @return boolean
     **/
    static boolean haveRight(String $module, int $right) {
//        global $DB;
//
...
//        }
     ...
     * @return boolean
     **/
    static boolean haveRightsAnd(String $module, int[] $rights) {
...
//        }
     ...
     * @return boolean
     **/
    static boolean haveRightsOr(String $module, int[] $rights) {
...
//        }
     ...
     * @return string
     **/
    static String getActiveTab(String $itemtype) {
...
//        $_SESSION['glpi_tabs'][strtolower($itemtype)] = $tab;
     ...
     *
     * @param $itemtype  name of itemtype
     * @param $name      name of the option
     * @param $defvalue  mixed default value for option
     * @return mixed
     * @since 0.83
     **/
    static String getSavedOption(String $itemtype, String $name, String $defvalue) {
...
//        }
     ...
     * @since 0.83
     **/
    static boolean isReadOnlyAccount() {
...
//        }
     ...
     * @since 0.83.3
     **/
    static public boolean validateCSRF(String[] $data) {
...
//        +$add_params;
     ...
     * @since 9.5.3
     **/
    static public boolean validateIDOR(String[] $data){
...
//        }
     ...
     * @since 0.85
     **/
    static boolean haveTranslations(String $itemtype, String $field) {

//        return (isset($_SESSION['glpi_dropdowntranslations'][$itemtype]) && isset($_SESSION['glpi_dropdowntranslations'][$itemtype][$field]));
        return true;
    }
     ...
     * @since 9.2.2
     */
    static boolean getCurrentInterface() {
...
//        if ($user_id <= 0 || self::getLoginUserID () == $user_id || (self::isImpersonateActive () && self::getImpersonatorId () == $user_id)){
...
//                $impersonator, $user -> fields['name']));
     ...
     * @return boolean
     */
    static boolean stopImpersonating() {
...
//                $user -> fields['name'], $impersonate_user));
     ...
     * @return boolean
     */
    static boolean isImpersonateActive() {
...
//        return array_key_exists('impersonator_id', $_SESSION);
     ...
     * @return string|null
     */
    static String getImpersonatorId() {
...
//        return self::isImpersonateActive () ? $_SESSION['impersonator_id'] : null;
     ...
     * @return boolean
     */
    static boolean mustChangePassword() {
//        return array_key_exists('glpi_password_expired', $_SESSION);
     ...
     * @since 9.5
     */
    public static int getActiveEntity() {
//        return $_SESSION['glpiactive_entity'] ??0;
     ...
     * @since 9.5.5
     */
    public static boolean getIsActiveEntityRecursive(){
//        return $_SESSION['glpiactive_entity_recursive'] ??false;
     ...
     * @param $token_type ID of the user
     * @param $entities_id ID of the user
     * @param $is_recursive ID of the user
     * @return User|bool
     */
